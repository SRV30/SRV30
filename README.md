...
| 💡 **SmartCare Health App**             | 1-year interdisciplinary project (CSE, ECE, ME) for smart health tracking & diagnostics. | React.js, Node.js, Firebase, IOT, Sensors | Team Lead + Fullstack Development  | [Link](https://drive.google.com/drive/u/0/folders/12DegYEyioMaslIgDk9zQMkI42pwe1fSx)                                        |
